						...
						@foreach(Auth::user()->candidate->languages->all() as $language)
							<li>
								<div class="job-listing">
									<div class="job-listing-details">
										<div class="job-listing-description">
											<h3 class="job-listing-title">{{ ucwords($language->language->first()->name) }}</h3>
										</div>
									</div>
								</div>
								...
								<div class="buttons-to-right">
									...
									<a href="" class="button red ripple-effect ico" title="Eliminar" data-tippy-placement="top"><i class="icon-feather-trash-2"></i></a>
								</div>
							</li>
						@endforeach
					</ul>
		...
		<div id="small-dialog-2" class="zoom-anim-dialog mfp-hide dialog-with-tabs">
			...
			<div class="sign-in-form">
				...
				<div class="popup-tab-content" id="tab2">
					...
					{{-- form --}}
					<form id="frmLanguage" method="post" action="{{ url('candidate/dashboard/curriculum/languages') }}">
						<div class="row">
							<div class="col-xl-7">
