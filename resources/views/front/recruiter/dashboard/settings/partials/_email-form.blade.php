		<div class="col-xl-12">
			<div class="dashboard-box margin-top-0">
				...
				<div class="headline">
					...
					<p>
						Si deseas cambair tu cuenta de correo electrónico por favor completa el siguiente formulario, te enviaremos una notificación a tu nuevo correo validando el hecho al términar el proceso.
					</p>
				</div>
				...
				<div class="content">
					<ul class="fields-ul">
						<li>
							<form action="{{ url('recruiter/dashboard/settings/email') }}" method="POST">
								<div class="row">
									<div class="col">
										<div class="row">
											<div class="col-xl-4">
